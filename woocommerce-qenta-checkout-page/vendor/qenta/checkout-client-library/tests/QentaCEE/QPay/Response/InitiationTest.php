...
class QentaCEE_QPay_Response_InitiationTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->object     = new QentaCEE_QPay_Response_Initiation($zendHttpResponse);
    }
    ...
    {
        $this->assertEquals(QentaCEE_QPay_Response_Initiation::STATE_SUCCESS, $this->object->getStatus());
    }
    ...
    public function testGetStatusFailed()
    {
        ...
        $this->assertEquals(QentaCEE_QPay_Response_Initiation::STATE_FAILURE, $this->object->getStatus());
    }
    ...
    protected function _fail200Response()
    {
        ...
        return new QentaCEE_QPay_Response_Initiation($zendHttpResponse);
    }
