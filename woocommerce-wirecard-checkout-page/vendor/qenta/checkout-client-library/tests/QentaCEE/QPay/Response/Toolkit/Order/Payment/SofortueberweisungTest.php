...
class QentaCEE_QPay_Response_Toolkit_Order_Payment_SofortueberweisungTest extends TestCase
{

    /**
     * @var QentaCEE_QPay_Response_Toolkit_Order_Payment_Sofortueberweisung
     */
    protected $object;
