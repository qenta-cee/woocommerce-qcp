...
class WirecardCEE_QPay_PaymentTypeTest extends TestCase
{
    ...
    {
        $paymentType = WirecardCEE_QPay_PaymentType::EPS;
        $this->assertContains('BAWAG P.S.K. AG', WirecardCEE_QPay_PaymentType::getFinancialInstitutions($paymentType));
