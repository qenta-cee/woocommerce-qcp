...
define('WOOCOMMERCE_GATEWAY_WCP_VERSION', '1.1.4');
...
class WC_Gateway_WCP extends WC_Payment_Gateway
{
    ...
    function init_form_fields()
    {
        $this->form_fields = array(
            ...
            'title' => array(
                ...
                'type' => 'text',
                'description' => __('This controls the title which the user sees during checkout.', 'woocommerce-wcp'),
    ...
    function process_payment($order_id)
    {
        ...
        if (!$this->is_paymenttype_enabled($paymenttype)) {
            wc_add_notice( __('Payment type is not available, please select another payment type.', 'woocommerce-wcp'), 'error');
            return false;
        }
